...
if (imu.accelAvailable())
 ...
 delt_t = millis() - count;
  ...
  /*
  Serial.println(imu.gBias[0]);
  Serial.println(imu.gBias[1]);
  Serial.println(imu.gBias[2]);
  //Serial.println(imu.aBias[0],imu.aBias[1],imu.aBias[2]);
  Serial.print(state.getRoll()*(180.0f / PI));
  Serial.print(" deg, ");
  Serial.print(state.getPitch()*(180.0f / PI));
  Serial.println(" deg");
  */
...
void setupAccel()
{
  ...
  // 0 = 408 Hz   2 = 105 Hz
  // 1 = 211 Hz   3 = 50 Hz
  imu.settings.accel.bandwidth = 3; // BW = 408Hz
...
void setupMag()
{
  ...
  // 2 = 2.5 Hz    6 = 40 Hz
  // 3 = 5 Hz      7 = 80 Hz
  imu.settings.mag.sampleRate = 4; // Set OD rate to 20Hz
